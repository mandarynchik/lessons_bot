...
from . settings import telegram_bot_token, ok_codes, hello_message, message_unknown_country,available_currency_countries, something_went_message
	...
	def get_updates(self)->dict:
		...
		try:
			...
			if res.status_code in ok_codes:
				...
				print(f"Запрос по адресу {updates_url} получил ответ со статусом {res.status_code}")
